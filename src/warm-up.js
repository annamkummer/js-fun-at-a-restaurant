...
var vegetables = ["tomato", "carrot", "radish", "celery", "lettuce"];
...
// different fruits.
var fruits = ["kiwi", "orange", "watermelon", "bluberry", "banana", "apple", "plum"];
...
var groceryStore = {
  ...
  isOpen: true,
  hasStarbucks: true,
  departments: ["produce", "bakery", "dairy", "meats", "frozen", "canned goods"]
}
